...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-github-dark text-github-text" data-testid="dashboard">
      <PanelGroup direction="horizontal" className="min-h-screen">
        {/* Left Sidebar Panel */}
        <Panel defaultSize={20} minSize={15} maxSize={35} className="bg-github-surface border-r border-github-border">
        ...
        {/* Resize Handle */}
        <PanelResizeHandle className="w-2 bg-github-border hover:bg-github-blue/50 transition-colors cursor-col-resize data-[panel-group-direction=vertical]:cursor-row-resize data-[panel-group-direction=vertical]:h-2 data-[panel-group-direction=vertical]:w-full" />

        {/* Main Content Panel */}
        <Panel defaultSize={repositoryAnalysis ? 55 : 80} minSize={40}>
          <div className="h-full flex flex-col">
            {/* Top Bar */}
        ...
        {/* Analytics Sidebar Panel (only show when repository is selected) */}
        {repositoryAnalysis && (
          <>
            <PanelResizeHandle className="w-2 bg-github-border hover:bg-github-blue/50 transition-colors cursor-col-resize data-[panel-group-direction=vertical]:cursor-row-resize data-[panel-group-direction=vertical]:h-2 data-[panel-group-direction=vertical]:w-full" />
